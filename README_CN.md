...
> 等仓库收获第一批 star 后，将 `YOUR_USERNAME/YOUR_REPO_NAME` 替换为实际仓库路径。
...
> 将 `YOUR_USERNAME/YOUR_REPO_NAME` 替换为实际仓库路径。
...
- 💬 讨论：[GitHub Discussions](https://github.com/YOUR_USERNAME/YOUR_REPO_NAME/discussions)
- 🐛 问题：[GitHub Issues](https://github.com/YOUR_USERNAME/YOUR_REPO_NAME/issues)
